...
public class ClientImpl implements Client {
    ...
    private String name;
    private Collection<String> desiredOrders;
    private Collection<String> servingWaiters; //additional

    public ClientImpl(String name) {
        setName(name);
        this.desiredOrders = new ArrayList<>();
        this.servingWaiters = new ArrayList<>();
    }
