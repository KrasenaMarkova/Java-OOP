package exampreparation.christmasPastryShop.core;

import exampreparation.christmasPastryShop.common.ExceptionMessages;
import exampreparation.christmasPastryShop.common.OutputMessages;
import exampreparation.christmasPastryShop.common.enums.DelicacyType;
import exampreparation.christmasPastryShop.common.enums.CocktailType;
import exampreparation.christmasPastryShop.common.enums.BoothType;
import christmasPastryShop.core.interfaces.Controller;
import exampreparation.christmasPastryShop.entities.delicacies.Gingerbread;
import exampreparation.christmasPastryShop.entities.delicacies.Stolen;
import exampreparation.christmasPastryShop.entities.delicacies.interfaces.Delicacy;
import exampreparation.christmasPastryShop.entities.drinks.MulledWine;
import exampreparation.christmasPastryShop.entities.drinks.Hibernation;
import exampreparation.christmasPastryShop.entities.drinks.interfaces.Cocktail;
import exampreparation.christmasPastryShop.entities.booths.OpenBooth;
import exampreparation.christmasPastryShop.entities.booths.PrivateBooth;
import exampreparation.christmasPastryShop.entities.booths.interfaces.Booth;
...
public class ControllerImpl implements Controller {
    private final exampreparation.christmasPastryShop.repositories.interfaces.DelicacyRepository<Delicacy> delicacyRepository;
    private final exampreparation.christmasPastryShop.repositories.interfaces.CocktailRepository<Cocktail> cocktailRepository;
    private final exampreparation.christmasPastryShop.repositories.interfaces.BoothRepository<Booth> boothRepository;
    private double totalIncome;

    public ControllerImpl(exampreparation.christmasPastryShop.repositories.interfaces.DelicacyRepository<Delicacy> delicacyRepository, exampreparation.christmasPastryShop.repositories.interfaces.CocktailRepository<Cocktail> cocktailRepository, BoothRepository<Booth> boothRepository) {
